...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:view hotel bookings')->group(function () {
        Route::get('/dashboard/my-bookings', [DasboardController::class, 'my_bookings'])
            ->name('dashboard.my-bookings');
        Route::get('/dashboard/my-bookings/{hotelBooking}', [DasboardController::class, 'booking_details'])
            ->name('dashboard.booking_details');
    });
    

    Route::prefix('admin')->name('admin.')->group(function(){
        Route::middleware('can:menage cities')-> group(function(){
            Route::resource('cities',CityController::class);
        });

        Route::middleware('can:menage countries')-> group(function(){
            Route::resource('countries',CountryController::class);
        });

        Route::middleware('can:menage hotels')-> group(function(){
        ...
        Route::middleware('can:menage hotel bookings')-> group(function(){
